...
- `BOOT-002 @ T0-1980S @ none` — 1980年代側の物語最初の実働開始点候補
...
現時点では、**哲学・技術史を圧縮した導入から1980年代側へ入り、PER-005の研究・実験を動かし始める**ことをnarrative entry候補とする。ただし、第1話のscene境界や終了点までは固定しない。
